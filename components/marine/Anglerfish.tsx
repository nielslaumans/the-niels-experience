...
export default function Anglerfish({ size = 200 }: Props) {
  return (
    <svg width={size} height={size * 0.6} viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <defs>
      ...
      <path d="M80 55 Q70 35, 55 22" stroke="#1a1a2e" strokeWidth="2" fill="none" />
      <path d="M60 80 Q90 35, 150 60 Q175 70, 175 75 Q175 85, 150 95 Q90 110, 60 80 Z" fill="#020812" stroke="#0a3d6b" strokeWidth="1" />
