...
type FishProps = { variant?: "tropical" | "silver" | "deep"; size?: number; color?: string };

export default function Fish({ variant = "tropical", size = 40, color }: FishProps) {
  if (variant === "tropical") {
    const fill = color ?? "#ffb347";
    return (
      <svg width={size} height={size * 0.6} viewBox="0 0 100 60" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <defs>
        ...
        <path d="M10 30 Q35 5, 70 30 Q35 55, 10 30 Z" fill="url(#trop)" opacity="0.95" />
  ...
  if (variant === "silver") {
    return (
      <svg width={size} height={size * 0.4} viewBox="0 0 100 40" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <defs>
  ...
  return (
    <svg width={size} height={size * 0.55} viewBox="0 0 100 55" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <defs>
      ...
      <path d="M10 28 Q35 8, 65 28 Q35 48, 10 28 Z" fill="#0a3d6b" stroke="#00f0ff" strokeOpacity="0.7" strokeWidth="1" />
