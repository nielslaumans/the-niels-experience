...
export default function Whale({ size = 380 }: Props) {
  return (
    <svg width={size} height={size * 0.45} viewBox="0 0 400 180" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <defs>
      ...
      <path d="M20 90 Q60 50, 160 60 Q260 65, 320 80 Q360 90, 380 90 L380 95 Q360 100, 320 105 Q310 130, 290 130 Q280 130, 275 115 Q220 125, 160 120 Q60 130, 20 100 Z" fill="url(#whaleBody)" opacity="0.9" />
